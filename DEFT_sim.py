...
class DEFT_sim(nn.Module):
    ...
    def __init__(
        ...
        n_vert: int
            Number of vertices in theparent branch .
        cs_n_vert: tuple
    ...
    def branch_forward(
        ...
        return (External_force[:, :self.n_vert]) * batch_clamped_index, theta_full
    ...
    def iterative_sim(
        ...
        for ith in range(1):
            ...
            with torch.autograd.profiler.record_function("GNN_forward"):
            ...
            if inference_1_batch:
                ...
                for constraint_loop_i in range(constraint_loop):
                    ...
                    print("inextensibility at iterative sim constraint loop")
