...
def train(train_batch, BDLO_type, total_time, train_time_horizon, undeform_vis, inference_vis, inference_1_batch,
    ...
    # print('b_undeformed_vert in train', b_undeformed_vert)
    ...
    # print('b_undeformed_vert at DEFT sim eval',b_undeformed_vert)
    ...
    if model == "DEFT":
        ...
        for epoch in range(train_epoch):
            ...
            for data in bar:
                ...
                if save_steps % evaluate_period == 0:
                    ...
                    with torch.no_grad():
                        for eval_data in eval_bar:
                            ...
                            # print("???", DEFT_sim_train.undeformed_vert)
                ...
                with torch.autograd.profiler.profile(record_shapes=True, with_stack=True) as prof:
